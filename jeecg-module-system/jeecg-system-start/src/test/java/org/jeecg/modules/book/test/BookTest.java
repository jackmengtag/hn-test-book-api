package org.jeecg.modules.book.test;
...
public class BookTest {
     ...
     * 测试地址：实际使用时替换成你自己的地址
     */
    private final String BASE_URL = "http://localhost:8080/jeecg-boot/book/hnBook/";
    //测试：用户名和密码
    ...
    public void testAdd() {
        ...
        params.put("title", "java书籍");
        params.put("author", "李四");
        params.put("publishtime",new Date());
        params.put("sbn", "20240318001");
        params.put("bookname", "java设计模式");
        params.put("createTime", new Date());
        params.put("createBy", "testUser");
...
//        params.put("workNo","0025");
    ...
    public void testEdit() {
        // 数据Id
        String dataId = "1766271563796004866";
        // 请求地址
        ...
        JSONObject params = new JSONObject();
        params.put("title", "wangwuTest");
        params.put("author", "王五");
        params.put("publishtime", new Date());
        params.put("sbn","20240318002");
        params.put("bookname","java编程思想");
        params.put("updateBy","testUser");
